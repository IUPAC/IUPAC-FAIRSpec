{"IFS-extract-version":"0.1.0-alpha","pathway":[
 ...
 {"path":"IFS.finding.aid.object::{data}|alkylation original FID submitted"}, 
 {"objects":"{path}/{IFS.nmr.representation.vender.dataset::{id=IFS.structure.param.compound.id::*}/{IFS.nmr.param.expt::*}/**/*}"}
]}