{"IFS-extract-version":"0.1.0-alpha","pathway":[
 ...
 {"path":"IFS.finding.aid.object::{data}|primary NMR data"},
 {"objects":"{path}/{id=IFS.structure.param.compound.id::*}/{IFS.nmr.representation.vender.dataset::{id}-{IFS.nmr.param.expt::*}/**/*}"}
]}