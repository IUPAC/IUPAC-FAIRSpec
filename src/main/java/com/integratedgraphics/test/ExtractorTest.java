...
public class ExtractorTest extends MetadataExtractor {
	 ...
	 *  [ifdExtractJSONFilename, sourceArchive, targetDir, flags...]
	 *  
	 * @param args
	 * @param sourceArchive
	 * @param targetDir
	 * @return
	 */
	protected static String[] setSourceTargetArgs(String[] args, String ifdExtractJSONFilename, String sourceArchive, String targetDir, String flags) {
		if (args == null)
			args = new String[0];
		String[] a = new String[Math.max(4,  args.length)];
		a[0] = (args.length < 1 || args[0] == null ? ifdExtractJSONFilename : args[0]);
		a[1] = (args.length < 2 || args[1] == null ? sourceArchive : args[1]);
