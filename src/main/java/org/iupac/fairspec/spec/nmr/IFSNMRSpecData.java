...
public class IFSNMRSpecData extends IFSSpecData {
...

	{
		super.setProperties(new IFSProperty[] {
				...
				new IFSProperty(IFSNMRSpecData.IFS_PROP_SPEC_NMR_INSTR_FREQ_NOMINAL, IFSConst.PROPERTY_TYPE.INT, IFSConst.PROPERTY_UNITS.MHZ),
				...
				new IFSProperty(IFSNMRSpecData.IFS_PROP_SPEC_NMR_EXPT_FREQ_1, IFSConst.PROPERTY_TYPE.INT, IFSConst.PROPERTY_UNITS.MHZ),
				new IFSProperty(IFSNMRSpecData.IFS_PROP_SPEC_NMR_EXPT_FREQ_2, IFSConst.PROPERTY_TYPE.INT, IFSConst.PROPERTY_UNITS.MHZ),
